...
namespace Pumukit\ImportBundle\Document;
...
/**
 * Pumukit\ImportBundle\Document\Broadcast.
 *
 * @deprecated in version 2.3
 *
 * @MongoDB\Document(repositoryClass="Pumukit\ImportBundle\Repository\BroadcastRepository")
 */
class Broadcast
{
